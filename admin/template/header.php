...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= ROOT ?>admin/?page=room_type"
               aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-pager"></i>
                <span>Quản lý loại phòng: </span>
            </a>
        </li>
        <li class="nav-item">
...
<!--                    <a class="collapse-item" href="javascript:;">Colors</a>-->
<!--                    <a class="collapse-item" href="javascript:;">Borders</a>-->
<!--                    <a class="collapse-item" href="javascript:;">Animations</a>-->
<!--                    <a class="collapse-item" href="javascript:;">Other</a>-->
<!--                </div>-->
<!--            </div>-->
<!--        </li>-->
        <!-- Divider -->
        ...
        <!--                    <a class="collapse-item" href="--><? //= ROOT ?><!--public/login.php">Login</a>-->
        <!--                    <a class="collapse-item" href="--><? //= ROOT ?><!--public/register.php">Register</a>-->
        <!--                    <a class="collapse-item" href="-->
        <? //= ROOT ?><!--public/forgot-password.php">Forgot Password</a>-->
        <!--                    <div class="collapse-divider"></div>-->
        <!--                    <h6 class="collapse-header">Other Pages:</h6>-->
        <!--                    <a class="collapse-item" href="javascript:;">404 Page</a>-->
        <!--                    <a class="collapse-item" href="javascript:;">Blank Page</a>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </li>-->
        <!-- Nav Item - Charts -->
